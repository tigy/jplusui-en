...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
	...
	<xsl:template match="/docs">
		...
		<body id="docs">
			<div id="header">
				<div id="headerMain">
					<h2>XSLT/CSS/JS Written by <a href="http://shawphy.com">Xuld</a> Translated by <a href="http://www.cn-cuckoo.com/">chunterg</a>, <a href="http://shawphy.com">Shawphy</a> and <a href="http://cloudream.name">Cloudream</a>.</h2>
